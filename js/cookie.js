$(
    function () {
        ...
        if ( ! ck ) {
            $("body").append(
                "<section id='cookie'>\
                    Questo sito utilizza cookie tecnici per offrirti una migliore esperienza di navigazione sul sito. Per maggiori informazioni premi\
                    <a href='cookies.htm'>questo link</a> oppure \
